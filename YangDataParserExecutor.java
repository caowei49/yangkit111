...
public class YangDataParserExecutorJson {
    ...
    public static void main(String[] args)
        ...
        //String xmlPath = "D:\\AR_0531_without.xml";
        String xmlPath = "D:\\debugjson.json";

        String yangPath = "D:\\AR8140_V600R023C00_B191";
        //String yangPath = "D:\\yangfiles";
        ...
        String fileName = "D:\\debugjson.json";
        JsonNode element = null;
        try {
            ObjectMapper objectMapper = new ObjectMapper();
            element = objectMapper.readTree(new File("D:/debugjson.json"));
        } catch (IOException e) {
            e.printStackTrace();
        }
