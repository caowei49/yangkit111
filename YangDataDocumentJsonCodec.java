...
//    private void buildAttributes(JsonNode element, List<Attribute> attributes) {
//        if (null == attributes) {
//            return;
//        }
//
//        for (org.yangcentral.yangkit.common.api.Attribute attribute : attributes) {
//            String name = attribute.getName().getQualifiedName();
//            ((ObjectNode) element).putPOJO("@" + name, attribute);
//        }
//    }
